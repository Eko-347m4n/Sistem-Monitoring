  ...
  return (
    <div className="rounded-xl bg-white p-4 shadow-sm border border-gray-100 mb-4">
      <div className="flex justify-between items-start mb-2">
         <div>
            <h4 className="font-bold text-gray-800">{assignment.work_unit.pre_order.order_code}</h4>
            <p className="text-sm text-gray-500">{assignment.work_unit.pre_order.customer_name}</p>
         </div>
      ...
      <form onSubmit={handleUpdate} className="mt-4 space-y-3">
        <div>
            ...
            <div className="flex justify-between text-xs text-gray-500 mt-1">
                ...
                <span className="font-bold text-blue-600">New: {progress}%</span>
            </div>
        </div>
        ...
        <button 
           ...
           className="w-full bg-gray-900 text-white text-sm py-2 rounded hover:bg-black disabled:opacity-50 disabled:cursor-not-allowed"
        >
